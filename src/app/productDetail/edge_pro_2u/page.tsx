...
export default function EdgePro2USpec() {
  return (
    <>
      <ProductCommon />
      <main className="max-w-5xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-6 text-center">Edge Pro 2U Specification</h1>
        <div className="relative w-full max-w-md mx-auto my-6">
          <Image
            src="/edge_pro_2u.jpg" // Replace with actual image path in /public
            alt="Edge Pro 2U"
            width={500}
            height={300}
        ...
        <table className="w-full border border-gray-300 text-sm table-auto">
          <tbody>
            <tr className="bg-gray-100">
              ...
              <td className="border px-4 py-2">Edge Pro 2U</td>
            </tr>
            <tr>
              <td className="border px-4 py-2 font-semibold">Form Factor</td>
              <td className="border px-4 py-2">2U Rackmount</td>
            </tr>
            <tr className="bg-gray-100">
            ...
            <tr>
              ...
              <td className="border px-4 py-2">
                1 x OCP 3.0 Slot (x16 PCIe 5.0)<br />
                Expansion Riser Slots:<br />
                - 1 x DS FHFL (x16 PCIe 5.0, TDP up to 350W, e.g. L40S)<br />
                - 2 x SS FHFL (x8 PCIe 5.0, TDP up to 75W)
              </td>
            </tr>
            <tr className="bg-gray-100">
