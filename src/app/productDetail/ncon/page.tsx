...
export default function NCONSpec() {
  return (
        <>
            <ProductCommon />
    <main className="max-w-5xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6 text-center">AIM-Edge NCON Specification</h1>
      ...
      <table className="w-full border border-gray-300 text-sm table-auto">
        <tbody>
          <tr className="bg-gray-100">
            ...
            <td className="border px-4 py-2">AIM-Edge ncon</td>
          </tr>
          <tr>
            <td className="border px-4 py-2 font-semibold">Processor (CPU)</td>
            <td className="border px-4 py-2">NVIDIA Jetson Orin Nano (up to 40/20 TOPS)</td>
          </tr>
          <tr className="bg-gray-100">
          ...
          <tr className="bg-gray-100">
            ...
            <td className="border px-4 py-2">1 x PCIE M.2 SSD (128GB)</td>
          </tr>
          <tr>
          ...
          <tr className="bg-gray-100">
            ...
            <td className="border px-4 py-2">
              AI Edge Inference System with NVIDIA Jetson Orin Nano<br />
