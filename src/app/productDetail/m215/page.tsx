...
export default function M215Spec() {
  return (
    <>
      <ProductCommon />
      <main className="max-w-5xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-6 text-center">M215 Specification</h1>
        ...
        <table className="w-full border border-gray-300 text-sm table-auto">
          <tbody>
            <tr className="bg-gray-100">
              ...
              <td className="border px-4 py-2">M215</td>
            </tr>
            <tr>
            ...
            <tr className="bg-gray-100">
              ...
              <td className="border px-4 py-2">22” (16:9)</td>
            </tr>
            <tr>
